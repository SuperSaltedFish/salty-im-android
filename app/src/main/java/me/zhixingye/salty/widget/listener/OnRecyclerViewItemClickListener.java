...
public abstract class OnRecyclerViewItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    private final GestureDetectorCompat mGestureDetector = new GestureDetectorCompat(SaltyApp.getAppContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onSingleTapUp(MotionEvent event) {
            ...
            if (itemView != null) {
                ...
                if (nowTime - lastClickTime >= MAX_CLICK_INTERVAL) {
                    ...
                    onItemClick(viewHolder.getBindingAdapterPosition(), viewHolder, event.getX(), event.getY());
        ...
        public void onLongPress(MotionEvent event) {
            ...
            if (itemView != null) {
                RecyclerView.ViewHolder viewHolder = mRecyclerView.getChildViewHolder(itemView);
                onItemLongClick(viewHolder.getBindingAdapterPosition(), viewHolder, event.getX(), event.getY());
            }
        }
    });
