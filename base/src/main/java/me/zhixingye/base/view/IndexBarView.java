...
public class IndexBarView extends View {
    ...
    private void initView() {
        ...
        mSelectedTextColor = getThemeColor(getContext(), android.R.attr.textColorPrimary, Color.BLACK);
        mUnselectedTextColor = getThemeColor(getContext(), android.R.attr.textColorSecondary, Color.GRAY);
    }
