...
public class StrangerProfilePresenter implements StrangerProfileContract.Presenter {
    ...
    public void requestAddContact(String userId, String addReason) {
        IMClient.get().getContactService().requestContact(userId, addReason, new MVPRequestCallback<RequestContactResp>(mView) {
            @Override
    ...
    public void acceptAddContact(String userId) {
        IMClient.get().getContactService().acceptContact(userId, new MVPRequestCallback<AcceptContactResp>(mView) {
            @Override
    ...
    public void refusedAddContact(String userId, String rejectReason) {
        IMClient.get().getContactService().refusedContact(userId, rejectReason, new MVPRequestCallback<RefusedContactResp>(mView) {
            @Override
