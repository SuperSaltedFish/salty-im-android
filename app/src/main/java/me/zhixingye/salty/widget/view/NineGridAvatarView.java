...
public class NineGridAvatarView extends ViewGroup {
    ...
    private final List<Object> mAvatarUrlList = new ArrayList<>(9);
    ...
    private void updateView() {
        ...
        if (urlCount == 0) {
            for (int i = 0; i < childCount; i++) {
                GlideUtil.clear(getContext(), (ImageView) getChildAt(i));
            }
            removeAllViews();
            return;
        }
        if (urlCount > childCount) {
            ...
            for (int i = childCount; i > urlCount; i--) {
                ...
                GlideUtil.clear(getContext(), view);
                view.setImageBitmap(null);
                removeViewAt(i - 1);
            }
        }
        for (int i = 0; i < urlCount; i++) {
            GlideUtil.loadAvatarFromUrl(getContext(), (ImageView) getChildAt(i), mAvatarUrlList.get(i));
        }
    }
